...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  final List<String> _titlesList = [
    ...
    'Send Photos'.tr(),
    'Get Notified'.tr(),
    'We will ask you series of questions to aide us in making perfect match'
  ];
            ...
            child: Align(
              ...
              child: Padding(
                padding: const EdgeInsets.only(
                    right: 40.0, left: 40.0, top: 40, bottom: 200),
                child: ConstrainedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      pushReplacement(context, OnBoardingQuestionOneScreen());
                    },
                  ),
                ),
              ),
